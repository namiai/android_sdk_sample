...
import ai.nami.shared_sample.common.BaseScreen
...
fun HomeScreen(
    ...
    val sdUIVersions = listOf<String?>("0.15.0","0.14.0", "0.13.0", "0.12.0", "0.11.0", null)
    ...
    var customBaseUrl by rememberSaveable {
        mutableStateOf("http://192.168.1.6:5001")
    }
    ...
    BaseScreen(isLoading = isLoading) {
        ...
        Button(modifier = Modifier.fillMaxWidth(), onClick = {
            sendViewIntent(HomeViewIntent.InitNamiSDK )
